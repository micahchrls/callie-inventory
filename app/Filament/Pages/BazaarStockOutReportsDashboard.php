...
use App\Exports\BazaarStockOutReportsExport;
...
class BazaarStockOutReportsDashboard extends Page implements HasForms, HasTable
{
    ...
    protected function exportReport($period)
    {
        ...
        // Use the corrected BazaarStockOutReportsExport class
        return Excel::download(
            new BazaarStockOutReportsExport(
                $period,
                $dateRange['start'],
                $dateRange['end'],
                $periodLabel
