...
class TiktokStockOutReportsExport implements FromCollection, WithColumnWidths, WithHeadings, WithMapping, WithStyles, WithTitle
{
    ...
    {
        return 'Tiktok Stock Out Report - '.$this->periodLabel;
    }
}
