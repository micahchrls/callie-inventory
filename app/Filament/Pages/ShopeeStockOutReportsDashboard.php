...
use App\Exports\ShopeeStockOutReportsExport;
...
class ShopeeStockOutReportsDashboard extends Page implements HasForms, HasTable
{
    ...
    protected static ?string $title = 'Shopee Stock Out Reports';

    protected static ?string $navigationLabel = 'Shopee Stock Out Reports';
    ...
    public function getTitle(): string
    {
        ...
        return 'Shopee Stock Out Report - '.$periodLabel;
    }
    ...
    protected function exportReport($period)
    {
        ...
        // Generate filename
        $filename = 'shopee-stock-out-report-'.strtolower(str_replace([' ', ','], '-', $periodLabel)).'-'.now()->format('Y-m-d-His').'.xlsx';
        ...
        return Excel::download(
            new ShopeeStockOutReportsExport(
                $period,
                $dateRange['start'],
                $dateRange['end'],
                $periodLabel
