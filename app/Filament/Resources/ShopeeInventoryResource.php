...
class ShopeeInventoryResource extends Resource
{
    protected static ?string $model = ProductVariant::class;

    protected static ?string $navigationIcon = 'heroicon-o-shopping-bag';

    protected static ?string $navigationLabel = 'Shopee Inventory';

    protected static ?string $modelLabel = 'Shopee Product';

    protected static ?string $pluralModelLabel = 'Shopee Inventory';
                ...
                Forms\Components\Section::make('Product Information')
                    ->schema([
                        ...
                        Forms\Components\TextInput::make('platform_name')
                            ...
                            ->disabled()
                            ->dehydrated(false)
                            ->formatStateUsing(fn ($record) => $record?->platform?->name ?? 'Shopee'),
                    ])
                    ->collapsible()
                    ->collapsed(false),
                ...
                Tables\Actions\Action::make('quick_adjust')
                    ...
                    ->action(function (array $data, $record): void {
                        ...
                        $record->stockMovements()->create([
                            'type' => $data['adjustment'] > 0 ? 'restock' : 'adjustment',
    ...
    {
        return [
            'index' => Pages\ListShopeeInventories::route('/'),
            'create' => Pages\CreateShopeeInventory::route('/create'),
            'view' => Pages\ViewShopeeInventory::route('/{record}'),
            'edit' => Pages\EditShopeeInventory::route('/{record}/edit'),
        ];
    }
