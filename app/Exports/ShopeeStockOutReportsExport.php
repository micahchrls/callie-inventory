...
class ShopeeStockOutReportsExport implements FromCollection, WithColumnWidths, WithHeadings, WithMapping, WithStyles, WithTitle
{
    ...
    {
        return 'Shopee Stock Out Report - '.$this->periodLabel;
    }
}
